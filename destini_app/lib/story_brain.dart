...
class StoryBrain {
  ...
  void nextStory(bool opt) {
    switch (_storyNumber) {
      case 0:
        opt ? _storyNumber += 2 : _storyNumber++;
        break;
      case 1:
        opt ? _storyNumber++ : _storyNumber += 2;
        break;
      case 2:
        opt ? _storyNumber += 3 : _storyNumber += 2;
        break;
      default:
        _restart();
    }
  ...
  bool buttonShouldBeVisible() => <int>[0, 1, 2].contains(_storyNumber);
}
